  ...
  <el-container>
    <el-main>
      <el-row>
        <el-col :span="1"
          ><router-link
            :to="{ name: 'EndIndex', params: { type: params } }"
            style="line-height: 1.5em;"
            ><i class="el-icon-arrow-left"></i></router-link
        ></el-col>
      ...
      <div class="hospital-info">
        ...
        <el-row>
          ...
          <el-col :span="12" align="right">{{
            params.receive_normal_check
          }}</el-col>
        </el-row>
        <el-row>
          <el-col :span="12" align="left">可做孕期产检B超</el-col>
          <el-col :span="12" align="right">{{
            params.receive_ultrasound
          }}</el-col>
        </el-row>
        <el-row>
          <el-col :span="12" align="left"
            >可做中孕期三维排畸彩超（大排畸）</el-col
          >
          <el-col :span="12" align="right">{{
            params.receive_clour_ultrasound
          }}</el-col>
        </el-row>
        <el-row>
          <el-col :span="12" align="left">可接生</el-col>
          <el-col :span="12" align="right">{{
            params.receive_accouche
          }}</el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-col :span="12" align="right" v-if="params.verify == 1"
            >已核实</el-col
          >
      ...
      <el-row>
        <el-col :span="24" align="left" style="margin-top: 3%;"
          >医院信息</el-col
        >
      </el-row>
      <div class="hospital-info">
        ...
        <el-row>
          ...
          <el-col :span="12" align="left"
            ><span v-for="phone in phones" v-bind:key="phone.id"
              >{{ phone.department }}:{{ phone.phone }}<br /></span
          ></el-col>
        </el-row>
      </div>
    </el-main>
    <el-footer
      ><el-button type="primary" plain
        ><router-link
          :to="{ name: 'EndHospitalEdit', params: { hospital: params } }"
...
export default {
  ...
  created() {
    ...
    let that = this;
    this.$http
      .get("/wh/msg/phone?uuid=" + this.params.uuid)
