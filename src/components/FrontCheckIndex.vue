    ...
    <div v-show="activeIndex !== 0" class="block">
      ...
      <div class="booklet">
        ...
        <div class="booklet-item">
          <img class="booklet-img" src="/static/img/prev1/prev1_021.jpg" />
        </div>
        ...
        <div class="booklet-item">
          <img class="booklet-img" src="/static/img/prev1/prev1_051.jpg" />
        </div>
        <div id="prev1_06" class="booklet-item">
          <img class="booklet-img" src="/static/img/prev1/prev1_06.jpg" />
        </div>
        <div class="booklet-item">
          <img class="booklet-img" src="/static/img/prev1/prev1_061.jpg" />
        ...
        <div class="booklet-item">
          <img class="booklet-img" src="/static/img/prev2/prev2_021.jpg" />
        </div>
        <div id="prev2_03" class="booklet-item">
          <img class="booklet-img" src="/static/img/prev2/prev2_03.jpg" />
        </div>
        <div class="booklet-item">
          <img class="booklet-img" src="/static/img/prev2/prev2_031.jpg" />
        </div>
        ...
        <div class="booklet-item">
          <img class="booklet-img" src="/static/img/prev3/prev3_021.jpg" />
        </div>
        <div id="prev3_03" class="booklet-item">
          <img class="booklet-img" src="/static/img/prev3/prev3_03.jpg" />
        </div>
        <div class="booklet-item">
          <img class="booklet-img" src="/static/img/prev3/prev3_031.jpg" />
        ...
        <div class="booklet-item">
          <img class="booklet-img" src="/static/img/prev4/prev4_021.jpg" />
        </div>
        <div id="prev4_03" class="booklet-item">
          <img class="booklet-img" src="/static/img/prev4/prev4_03.jpg" />
        </div>
        <div class="booklet-item">
          <img class="booklet-img" src="/static/img/prev4/prev4_031.jpg" />
        </div>
        ...
        <div class="booklet-item">
          <img class="booklet-img" src="/static/img/prev6/prev6_ref1.jpg" />
        </div>
        <div id="prev6_team" class="booklet-item">
          <img class="booklet-img" src="/static/img/prev6/prev6_team.jpg" />
        </div>
        <div class="booklet-item">
          <img class="booklet-img" src="/static/img/prev6/prev6_team1.jpg" />
...
export default {
  ...
  updated() {
    this.$nextTick(() => {
      let selector = this.activeCode;
      if (selector.includes('01')) {
  ...
  mounted() {
    let selector = this.$route.query.prevId;
    this.$nextTick(() => {
      if (selector) {
        this.isShow = false;
        this.activeIndex = selector;
        this.activeCode = selector;
        Info.$emit('on-tip-show', false);
        this.$el.querySelector('#' + selector + ' img').onload = () => {
          if (selector.includes('01')) {
            this.$el.querySelector('#' + selector).scrollIntoView();
          } else {
            this.$el.querySelector('#' + selector).scrollIntoView({
