        ...
        <div class="hospital-list" v-if="hospitallist.length">
          ...
          >
            ...
            >
              ...
              <div
                class="tel-btn"
                @click.stop="showPhoneDialog(hospital)"
                v-if="FrontType"
              >
            ...
            <div class="hospital-info" v-show="hospital.show">
              <edit-hospital
                :ref="mychild + hospital.id"
                @back="refreshList"
                v-if="EndType"
              ></edit-hospital>
              <template v-else-if="FrontType">
                <div
                  class="info-wrapper"
...
export default {
  name: "HostpitalList",
  mixins: [wxShare],
  components: { HospitalInfoItem, HeaderLayout, EditHospital },
  props: ["type"],
  data() {
    return {
      lastUpdateTime: "",
  ...
  methods: {
    ...
    showPhoneDialog(hospital) {
      return this.fetchPhoneInfo(hospital).then(() => {
        if (this.FrontType) this.dialogFormVisible = true;
      });
    },
